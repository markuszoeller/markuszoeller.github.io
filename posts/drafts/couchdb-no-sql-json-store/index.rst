...
.. post::
   :tags: template
   :title: CouchDB as distributed JSON store
...
===================================
*CouchDB* as distributed JSON store
===================================
...
* multi-master setup with replication
* json data store as back end for ((*dockerized*) application) configuration
* comparison to key-value stores like *etcd* (?)
* kill VM and rebuild it -> observe behavior
